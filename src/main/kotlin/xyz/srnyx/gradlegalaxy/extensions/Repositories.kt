...
open class Repositories {
    ...
    val GNOMECRAFT_RELEASES = "https://maven.gnomecraft.net/releases/"
    val GNOMECRAFT_SNAPSHOTS = "https://maven.gnomecraft.net/snapshots/"
    val NUCLEOID = "https://maven.nucleoid.xyz/"
